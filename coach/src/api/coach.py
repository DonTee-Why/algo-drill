...
from src.services.critique_service import critique as critique_submission
...
def critique(payload: Annotated[CritiquePayload, Body(embed=True, examples=[
    {
        "value": {
            ...
            "problem_context": {"title": "Two Sum", "description": "Given an array of integers, return indices of the two numbers such that they add up to a specific target.", "tags": ["array", "hash table"], "constraints": ["O(n)", "O(1)"], "signature": {"function_name": "twoSum", "params": [{"name": "nums", "type": "int[]"}, {"name": "target", "type": "int"}]}},
    ...
    return critique_submission(payload=payload)
